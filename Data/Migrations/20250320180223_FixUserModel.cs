    ...
    public partial class FixUserModel : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUser", x => new { x.CompletedCoursesId, x.UserId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseUser_Courses_CompletedCoursesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InProgressCoursesId = table.Column<int>(type: "int", nullable: false),
                    User1Id = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseUser1", x => new { x.InProgressCoursesId, x.User1Id });
                    table.ForeignKey(
                        name: "FK_CourseUser1_AspNetUsers_User1Id",
                        column: x => x.User1Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialType = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
